...
var (
	_ remote.ClientTransHandler = (*cliTransHandler)(nil)
...
func (h *cliTransHandler) NewStream(ctx context.Context, svcInfo *serviceinfo.ServiceInfo, conn net.Conn, handler remote.TransReadWriter) (streaming.Stream, error) {
