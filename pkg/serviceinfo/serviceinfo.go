...
const (
	StreamingBidirectional StreamingMode = "bidirectional"
	StreamingClient        StreamingMode = "client"
	StreamingServer        StreamingMode = "server"
	StreamingUnary         StreamingMode = "unary" // underlying protocol for streaming, like HTTP2
	StreamingNone          StreamingMode = ""      // KitexPB/KitexThrift
)
